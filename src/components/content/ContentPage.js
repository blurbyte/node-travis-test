  ...
  <div className={styles.wrapper}>
    <article className={styles.tile} role="main">
      ...
      <section>
        ...
        <p className={styles['main-paragraph']}>Simple Node.js application written in in React to test Travis CI with GitHub and Azure CI. It pushes build stright to Azure if all tests are passed.</p>
      </section>
      </div>
    </article>
  </div>
